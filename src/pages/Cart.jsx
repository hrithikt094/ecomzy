        ...
        (<div className="flex gap-16 max-w-6xl p-6 mx-auto flex-wrap lg:flex-nowrap">
          ...
          <div className="md:w-[30%] w-full flex flex-col gap-8 justify-between">
            ...
            <div className="mb-20">
              ...
              <button className="text-lg w-full py-2.5 rounded-lg font-bold text-white bg-[#15803d] border-2 
              border-[#15803d] hover:bg-white hover:text-[#15803d] transition-all duration-300 ease-in">
                Checkout Now
              </button>
            </div>
          </div>
